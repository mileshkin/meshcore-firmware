...
public:
  ...
  uint8_t screensaver_enabled = 0;  // UI screensaver enabled flag (0=disabled, 1=enabled)
  uint8_t screensaver_dimmed = 0;   // UI screensaver dimmed mode flag (0=normal brightness, 1=dimmed)
...
private:
  ...
  protected:
    void structure() override {
      ...
      def("screensaver_en", _parent->screensaver_enabled);
      def("screensaver_dim", _parent->screensaver_dimmed);
