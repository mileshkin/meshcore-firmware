...
private:
  ...
  protected:
    void structure() override {
      ...
      def("pwd", _parent->wifi_password, sizeof(_parent->wifi_password));
      def("mode", _parent->connection_type, sizeof(_parent->connection_type));
      def("pwr_save", _parent->wifi_power_save);
    }
  public:
  ...
  protected:
    void structure() override {
      def("interval", _parent->ntp_interval);
    }
  public:
